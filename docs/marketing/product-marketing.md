...
|DTSM|Brendan Hogan's trading community (joindtsm.com) — first beta cohort partner.|
...
**Customers:** First beta cohort via DTSM (Brendan Hogan, joindtsm.com) — planned alongside v0.2.0, currently in active development.
