...
//
// Local copy of the Reports FilterBar popover (kept standalone so FilterBar.tsx
// stays byte-untouched). Lightweight click-to-open; native <select multiple>
// is unusable for a polished bar.
