...
// The WEEK's words for its rule-breaks tab.
export const WEEK_RULE_BREAKS_WORDING: RuleBreaksWording = {
  tabLabel: 'Rule Breaks',
  title: 'Rules broken this week',
  subtitle: 'Tagged per day, so a day counts once no matter how many rules it broke.',
  empty: 'No rules broken this week.',
