...
// per trade; a week tags nothing of its own. Pure UI over
// WeekMetrics.mistakeTagCounts (computed in week.ts). Reinstated
// (djsevans87 #7) after the 2f51c52 display sweep.
