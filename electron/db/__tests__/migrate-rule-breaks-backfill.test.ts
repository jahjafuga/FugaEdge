...
describe('migrate-rule-breaks-backfill — schema 46 -> 47 version bump', () => {
  it('the head schema version is 50 (day_fees.fee_nscc bump; 47 was this beat)', () => {
    ...
    // Deliberately EXACT, not a floor — being the one pin that fails on every bump
    // is this test's whole job.
